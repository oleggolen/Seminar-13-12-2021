...
Делаем clone своей версии репозитория. Фиксируем изменения(делаем коммиты). Отправляем свою версию в свой gitHub. На сайте gitHub нажимаем кнопку pull request.    
